...
# ----------------------------------------------------
# 1. ฐานข้อมูลเมนูสินค้า (แยก 6 หมวดหมู่ 70+ รายการ)
# ----------------------------------------------------
coffee_menu = {
...
# ----------------------------------------------------
# 2. ฟังก์ชันช่วยประมวลผลหมวดหมู่ (Clean & Functional)
# ----------------------------------------------------
...
# ----------------------------------------------------
# 3. แสดงหน้าจอเลือกสินค้าแบบ Tabs
# ----------------------------------------------------
...
if total_drinks > 0 and total_food == 0:
    st.info("💡 **Smart Suggestion:** รับชิบุยาฮันนี่โทสต์หรือเค้กอร่อยๆ ไปทานคู่กับเครื่องดื่มเพิ่มไหมครับ?")

if 250 <= base_total < 300:
    shortage = 300 - base_total
    st.warning(f"🎉 **Smart Suggestion:** สั่งเพิ่มอีกเพียง **{shortage:.2f}** บาท จะได้รับส่วนลดพิเศษทันที 40 บาท!")

st.subheader(f"📊 ยอดรวมเบื้องต้น: **{base_total:.2f}** บาท (รวมค่าท็อปปิ้ง {topping_total} บาท)")

# ----------------------------------------------------
# 4. ส่วนลดและคำนวณภาษี (If-Elif-Else)
# ----------------------------------------------------
